...
\item La población de roedores incluye susceptibles (\$S\_v\$), infectados (\$I\_v\$) y recuperados (\$R\_v\$).
\item Existe una población ambiental de bacterias patógenas \$B\_l\$.
\end{itemize}

\subsection{Compartimentos y diagrama}
\begin{center}
\includegraphics\[width=0.9\textwidth]{modelo\_seir.png}
...
\begin{tabular}{@{}lllll@{}}
\toprule
\textbf{Parámetro} & \textbf{Descripción} & \textbf{Valor promedio} & \textbf{Unidades} & \textbf{Fuente} \\
\midrule
$\Lambda$ & Tasa de reclutamiento humana & $\mu \times N_{0,h}$ & humano/día & \cite{paisanwarakiat2021} \\
$\Pi$ & Tasa de reclutamiento de roedores & 2 & roedor/día & \cite{paisanwarakiat2021} \\
$\beta_{1,m}$ & Transmisión roedor-humano (promedio) & 0.00033 & 1/(roedor·día) & \cite{engida2022} \\
$\beta_{2,m}$ & Transmisión ambiente-humano (promedio) & 0.0815 & 1/día & \cite{engida2022} \\
$\beta_{3,m}$ & Transmisión humano-roedor (promedio) & 0.0007 & 1/(humano·día) & \cite{engida2022} \\
$\gamma$ & Pérdida de inmunidad humana & 0.089 & 1/día & \cite{khan2014} \\
$\mu$ & Mortalidad natural humana & 0.0009 & 1/día & \cite{alemneh2020,paisanwarakiat2021} \\
$\mu_v$ & Mortalidad natural roedores & 0.0029 & 1/día & \cite{alemneh2020} \\
$\mu_b$ & Mortalidad bacterias & 0.05 & 1/día & \cite{minter2019} \\
$\theta$ & Progresión expuesto a infectado & 0.092 & 1/día & \cite{khan2012} \\
$\alpha$ & Mortalidad por enfermedad & 0.04 & 1/día & \cite{engida2022} \\
$\delta$ & Recuperación humana & 0.072 & 1/día & \cite{engida2022} \\
$\rho$ & Pérdida de inmunidad roedores & 0.083 & 1/día & \cite{engida2022} \\
$\sigma$ & Recuperación roedores & 0.064 & 1/día & \cite{engida2022} \\
$\kappa$ & Constante de saturación ambiental & 10000 & - & \cite{engida2022} \\
$\tau_1$ & Liberación de patógeno por humanos & 0.06 & bacterias/(humano·día) & \cite{minter2019} \\
$\tau_2$ & Liberación de patógeno por roedores & 0.2 & bacterias/(roedor·día) & \cite{minter2019} \\
\bottomrule
\end{tabular}
...
[1] Engida, H. A., Theuri, D. M., Gathungu, D., Gachohi, J., & Alemneh, H. T. (2022). A Mathematical Model Analysis for the Transmission Dynamics of Leptospirosis Disease in Human and Rodent Populations. Computational and Mathematical Methods in Medicine, 2022, Article ID 1806585.

[5] R. Paisanwarakiat and R. Thamchai, Optimal Control of a Lep-
tospirosis Epidemic Model, Science & Technology Asia, 2021.

[6] A. Minter, F. Costa, H. Khalil et al., “Optimal control of rat-
borne leptospirosis in an urban environment,” Frontiers in
Ecology and Evolution, vol. 7, p. 209, 2019.

[29] H. T. Alemneh, “A co-infection model of dengue and leptospi-
rosis diseases,” Advances in Difference Equations, vol. 2020, 23
pages, 2020.

[30] M. A. Khan, G. Zaman, S. Islam, and M. I. Chohan, “Optimal
campaign in leptospirosis epidemic by multiple control vari-
ables,” Applied Mathematics, vol. 3, no. 11, pp. 1655–1663,
2012.

[31] M. A. Khan, S. Islam, S. A. Khan, I. Khan, S. Shaﬁe, and T. Gul,
“Prevention of leptospirosis infected vector and human popu-
lation by multiple control variables,” Abstract and Applied
Analysis, vol. 2014, Article ID 619035, 9 pages, 2014.
...
\midrule
$\phi$ ($\nu_{\max}$) & Tasa máxima de vacunación diaria & 0.01 & 1/día & Código/modelo \\
$\varepsilon$ & Eficacia de la vacuna & 0.78 & - & Vax-SPIRAL, ver abajo \\
$\omega$ & Pérdida de inmunidad vacunal & $1/180$ & 1/día & Vax-SPIRAL, ver abajo \\
\bottomrule
\end{tabular}
...
\subsection{Argumentación y sentido de las modificaciones}
...
\begin{itemize}
    ...
    \item \textbf{Mes pico $t_{\text{pico}}=2$ (febrero)}: Los brotes suelen alcanzar su máximo en febrero, coincidiendo con el final del verano austral y el periodo de mayor precipitación.
...
\subsubsection{Análisis de la Dinámica de Infectados ($I_h$)}


\includegraphics[width=0.85\textwidth]{infectados_comparacion.png}
...
\paragraph{Comparación y eficacia.} En todo el intervalo, el número de infectados es consistentemente menor en el escenario con vacunación, con una diferencia acumulada significativa en el área bajo la curva. Esto demuestra que la intervención vacunal dinámica no sólo atenúa los picos de infección, sino que reduce de forma sostenida la carga de enfermedad.
...
% Nota: agregar la siguiente entrada al archivo .bib
% @article{pijnacker2019,
%  title={Evaluating Leptospirosis Burden and Risk in the Netherlands Through Spatial Modelling and Surveillance Data},
%  author={Pijnacker, R and et al.},
...
\subsubsection{Análisis de la Dinámica de los Susceptibles ($S_h$)}

\includegraphics[width=0.85\textwidth]{susceptibles_comparacion.png}
...
\subsubsection{Análisis de la Dinámica de Expuestos ($E_h$)}

\includegraphics[width=0.85\textwidth]{expuestos.png}
...
%   title = {Leptospirosis - CDC Fact Sheet},
%   year = {2024},
%   url = {https://www.cdc.gov/leptospirosis/index.html}
% }


\subsubsection{Análisis de la Dinámica de Recuperados ($R_h$)}

\includegraphics[width=0.85\textwidth]{recuperados.png}
...
% Agregar esta entrada al archivo referencias.bib:
% @article{adler2010,
%   title={Leptospira and leptospirosis},
%   author={Adler, Ben and de la Peña Moctezuma, Alfredo},
...
%   publisher={Elsevier}
% }
\subsubsection{Análisis de la Dinámica de Vacunados ($V_h$)}

\includegraphics[width=0.85\textwidth]{vacunados.png}
\captionof{figure}{Evolución de vacunados (solo escenario con vacunación).}


La Figura representa la evolución temporal del compartimento de vacunados inmunizados ($V_h$) en humanos. En este compartimento se acumulan los individuos que han recibido la vacuna, esta ha sido eficaz (con probabilidad $\varepsilon$) y no han perdido aún la inmunidad inducida. Se comparan los escenarios con vacunación adaptativa (línea azul continua) y sin vacunación (línea naranja discontinua, constante en cero).
...
\paragraph{Sin vacunación.} En ausencia de intervención (línea naranja), el compartimento permanece en cero durante todo el año, confirmando la validez del modelo y la ausencia de protección vacunal.
...
% Agregar esta entrada al archivo referencias.bib:
% @article{goris2020,
%   title={Duration of immunity following vaccination against leptospirosis: A review of the available evidence},
%   author={Goris, M.G.A. and Hartskeerl, R.A.},
%   journal={Vaccine},
%   volume={38},
%   number={52},
%   pages={8326--8335},
...
\subsubsection{Análisis de la Tasa de Vacunación Diaria $\nu(t)$}

\includegraphics[width=0.85\textwidth]{vacunacion_diaria.png}
\captionof{figure}{Tasa diaria de vacunación a lo largo del tiempo (solo escenario con vacunación).}


La Figura muestra la evolución de la tasa de vacunación diaria $\nu(t)$ a lo largo del año. Esta tasa es calculada dinámicamente según la siguiente función dependiente de la prevalencia de infección y de la estacionalidad de la transmisión:

\[
\nu(t) = \nu_{\max} \cdot \left( \frac{I_h(t)}{I_h(t) + K} \right) \cdot \left( \frac{\beta_{\text{media}}(t)}{\beta_{\max}} \right)
\]

donde $\nu_{\max}$ representa la capacidad máxima de vacunación, $I_h(t)$ es el número de infectados humanos en el tiempo $t$, y $\beta(t)$ es la tasa de transmisión estacional, que alcanza su máximo en febrero.
...
% Agregar al archivo referencias.bib:
% @misc{who2023,
%   title = {Operational framework for managing zoonotic disease epidemics using One Health: WHO guidance},
%   author = {World Health Organization},
%   year = {2023},
%   url = {https://www.who.int/publications/i/item/9789240074441}
% }

\subsubsection{Análisis de la Dinámica de Vectores ($S_v$, $I_v$, $R_v$)}

\includegraphics[width=0.85\textwidth]{vectores.png}
...
% Agregar al archivo referencias.bib:
% @article{kassa2021,
%   title={Impact of host vaccination on vector-borne disease dynamics in a zoonotic context},
%   author={Kassa, Samson M and et al.},
...
\subsubsection{Análisis de la Dinámica de Bacterias en el Ambiente ($B_l$)}


\includegraphics[width=0.85\textwidth]{ambiente_comparacion.png}
\captionof{figure}{Dinámica de bacterias ambientales: comparación entre escenarios sin y con vacunación.}

La Figura muestra la evolución temporal del compartimento $B_l$, que representa la cantidad de bacterias *Leptospira* presentes en el ambiente (agua, suelo, zonas húmedas) en los escenarios con y sin vacunación humana. Este compartimento es esencial en la modelación ecoepidemiológica de la leptospirosis, pues actúa como reservorio infeccioso y amplificador de la transmisión indirecta.
...
% Agregar al archivo referencias.bib:
% @article{trueba2019,
%   title={Survival of pathogenic leptospira in the environment and its implications for leptospirosis control},
%   author={Trueba, Gabriel and Zapata, Sergio and Madrid, Kevin and Cullen, Peter},
...
\begin{itemize}
    \item \textbf{Casos evitados:} Se calcula la diferencia entre la incidencia acumulada de infecciones humanas en el escenario sin vacunación y con vacunación. La incidencia acumulada se estima integrando la el número de nuevos infectados ($\theta E_h$) a lo largo del periodo simulado.
...
\section{Costos asociados a la leptospirosis en Brasil y la vacuna Vax-SPIRAL®}

\begin{itemize}
    \item \textbf{Costo por dosis de Vax-SPIRAL®:} USD 15\footnotemark[2]. Este valor es una estimación asumida para el análisis, ante la ausencia de información pública sobre el precio comercial de la vacuna. La cifra se basa en rangos típicos de vacunas bacterianas en América Latina y puede variar según acuerdos institucionales y subsidios.

    \item \textbf{Proporción de casos leves:} 85\% (estimado global, incluye formas subclínicas y sintomáticas leves) \cite{who2022}.  

    \item \textbf{Proporción de casos moderados:} 5\%\footnotemark[2]
...
\begin{thebibliography}{9}
\bibitem{lepto-model} Engida, H. A., Theuri, D. M., Gathungu, D., Gachohi, J., & Alemneh, H. T. (2022). A Mathematical Model Analysis for the Transmission Dynamics of Leptospirosis Disease in Human and Rodent Populations. Computational and Mathematical Methods in Medicine, 2022, Article ID 1806585.
\bibitem{who} Organización Mundial de la Salud. Leptospirosis. Disponible en: \url{[https://www.who.int/news-room/fact-sheets/detail/leptospirosis}](https://www.who.int/news-room/fact-sheets/detail/leptospirosis})
\end{thebibliography}
